...
public enum ConsoleColour { 
    ...
    /**
     * Constructs a new ConsoleColour 
     *
     * @param description description of the color or style
     * @param colour The ANSI escape code 
     */
    ...
    /**
     * Gets the description of this color or style
     *
     * @return The description of the color or style
     */
    ...
    /**
     * Gets the ANSI escape code for this color or style as a formatted string
     *
     * @return The full ANSI escape code string for this color or style
     */
    ...
    /**
     * Converts the color or style to its ANSI escape code representation
     *
     * @return The ANSI escape code string for this color or style
     */
	@Override
